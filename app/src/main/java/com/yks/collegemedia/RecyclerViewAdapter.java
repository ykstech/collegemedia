...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    //    holder.imageNameTextView.setMovementMethod(LinkMovementMethod.getInstance());
...
//        }
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (item.getItemId() == 0) {
                    ...
                    if(onlytxt.equals("null")){
                       deletetxtpost(postid);
                    }else {
                        deltewithImage(postid);
                    }
    ...
    private void deltewithImage(final String postid) {
...
//                                MainImageUploadInfoList.size(), Toast.LENGTH_SHORT).show();
    ...
    private  void  deletetxtpost(final String postid){
        createnotification();
